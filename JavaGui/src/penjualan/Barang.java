...
public class Barang extends javax.swing.JFrame {
    ...
    static final String DB_URL = "jdbc:mysql://127.0.0.1/javagui?autoReconnect=true&useSSL=false";
    ...
    public void getData(){
        ...
        this.kode = String.valueOf(tabelData.getValueAt(baris,1));
    ...
    public void update(String kode, String nama, String satuan, int stok, int stokmin){
        try {
            ...
            String sql = "UPDATE barang SET kd_brg=?, nm_brg=?, satuan=?, stok=?, stokmin=? WHERE kd_brg='"+this.kode+"'";
